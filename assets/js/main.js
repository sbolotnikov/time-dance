...
{duration:2, x:Math.floor(widthW*.6),y:Math.floor(heightW*-0.5),ease:"linear"},
{duration:4, x:Math.floor(widthW*.1),y:Math.floor(heightW*-0.5),ease: "back"},
{duration:3, x:Math.floor(widthW*0.37),y:Math.floor(heightW*-0.27),ease: "slow"}];

var moveXY2=[{duration:4, x:Math.floor(widthW*-.5), y:Math.floor(heightW*0.1),ease:"linear"},
{duration:2, x:Math.floor(widthW*-.5),y:Math.floor(heightW*0.5),ease:"linear"},
{duration:4, x:Math.floor(0),y:Math.floor(heightW*0.5),ease: "back"},
{duration:3, x:Math.floor(widthW*-0.38),y:Math.floor(heightW*0.31),ease: "slow"}];
  ...
  function startHtml() {
    ...
    gsap.timeline({repeat:10, delay:7})
    ...
    gsap.timeline({repeat:10, delay:6.4})
